...
export const PERMISSION_CATALOG = [
  ...
  { key: 'services:manage',     label: 'Manage Services',    description: 'Can create, edit, and delete services and variations.' },
  { key: 'products:manage',     label: 'Manage Products',    description: 'Can create, edit, and delete products and orders.' },
  { key: 'content:manage',      label: 'Manage Content',     description: 'Can edit blog posts, before/after, offers, and FAQ.' },
  { key: 'settings:manage',     label: 'Manage Settings',    description: 'Can change site settings and view integrations like Semaphore.' },
