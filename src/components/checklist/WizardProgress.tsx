...
import type { InspectionPhaseMode } from './types';
...
export default function WizardProgress({ currentStep, maxReachedStep, onStepClick, inspectionMode = 'both' }: Props) {
  const wizardSteps = React.useMemo(() => {
    if (inspectionMode === 'before_only') {
      return [
        { id: 1, title: 'Inspection Mode', shortName: 'Mode' },
        { id: 2, title: 'Customer', shortName: 'Customer' },
        { id: 3, title: 'Vehicle', shortName: 'Vehicle' },
        { id: 4, title: 'Service & Model', shortName: 'Service' },
        { id: 5, title: 'Technician', shortName: 'Tech' },
        { id: 6, title: 'Before Checklist', shortName: 'Before' },
        { id: 7, title: 'Sign & Submit', shortName: 'Submit' },
      ];
    }
    if (inspectionMode === 'after_only') {
      return [
        { id: 1, title: 'Inspection Mode', shortName: 'Mode' },
        { id: 2, title: 'Customer', shortName: 'Customer' },
        { id: 3, title: 'Vehicle', shortName: 'Vehicle' },
    ...
    return [
      ...
      { id: 5, title: 'Technician', shortName: 'Tech' },
      { id: 6, title: 'Before Checklist', shortName: 'Before' },
      { id: 7, title: 'After Checklist', shortName: 'After' },
      { id: 8, title: 'Sign & Submit', shortName: 'Submit' },
    ];
  }, [inspectionMode]);

  const activeStepObj = wizardSteps.find(s => s.id === currentStep) || wizardSteps[0];
