-- Migration: 064_create_product_orders
-- Adds stock controls and order management for product checkout.

ALTER TABLE products
    ADD COLUMN track_stock TINYINT(1) NOT NULL DEFAULT 1 AFTER is_active,
    ADD COLUMN stock_qty INT NOT NULL DEFAULT 0 AFTER track_stock;

ALTER TABLE product_variations
    ADD COLUMN track_stock TINYINT(1) NOT NULL DEFAULT 1 AFTER sort_order,
    ADD COLUMN stock_qty INT NOT NULL DEFAULT 0 AFTER track_stock;
